...
export class SeoController {
    ...
    @Post('analyze/quick')
    async quickAnalyze(@Body() body: { content: string }) {
        return this.analyzerService.calculateContentStats(body.content);
    }

    @Post('analyze/suggestions')
    async getContentSuggestions(@Body() dto: AnalyzeContentDto) {
    ...
    @Put('keywords/:id')
    async updateKeyword(@Param('id') id: string, @Body() dto: UpdateKeywordTrackingDto) {
    ...
    async updateKeywordRanking(
        ...
        return this.seoService.updateKeywordRanking(id, body.position, body.searchEngine);
    }
    ...
    @Put('schemas/:id')
    async updateSchemaTemplate(@Param('id') id: string, @Body() dto: UpdateSchemaTemplateDto) {
