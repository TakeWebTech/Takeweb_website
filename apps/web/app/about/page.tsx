...
const leadership = [
    {
        ...
        role: "Founder & CEO",
        image: "/founder.jpg",
        bio: "Visionary leader dedicated to transforming enterprise technology through innovation and excellence. Himanshu leads the strategic direction of TakeWeb, ensuring we deliver world-class solutions to our global partners.",
...
export default function AboutPage() {
    ...
    return (
        <>
            ...
            {/* Mission & Vision */}
            <section id="mission" className="section-padding bg-[var(--bg-secondary)]">
                ...
                <div className="container-main">
                    <div className="relative rounded-3xl bg-gradient-to-br from-amber-500 to-amber-700 p-12 md:p-16 text-center overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <h2 className="text-white mb-4">Start Your Digital Journey</h2>
                            <p className="text-lg text-white/80 max-w-2xl mx-auto mb-8">
                                Partner with us to accelerate your digital transformation and achieve sustainable growth.
                            </p>
                            <Link
                                href="/contact"
