        ...
        <>
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <Image
                        src="/cover.png"
                        alt="TakeWeb Enterprise Background"
                        fill
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-amber-500/10 via-transparent to-purple-500/10 animate-gradient" />
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(179,155,94,0.15),transparent_50%)] animate-pulse" style={{ animationDuration: '4s' }} />
                ...
                <div className="container-main relative z-10 pt-24 pb-16">
                    <div className="max-w-4xl mx-auto text-center">
                        {/* Badge */}
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/20 text-sm font-medium text-amber-500 mb-8 animate-fade-in shadow-[0_0_20px_-5px_oklch(75%_0.15_85_/_0.2)]">
                            <span className="w-2 h-2 rounded-full bg-amber-500 animate-pulse" />
                            Trusted by 500+ global enterprises
                        </div>

                        {/* Headline */}
                        <h1 className="text-[var(--text-primary)] text-5xl md:text-7xl font-bold mb-8 animate-slide-up leading-tight tracking-tight">
                            Accelerating <br className="hidden md:block" />
                            <span className="bg-gradient-to-r from-amber-400 via-yellow-500 to-amber-600 bg-clip-text text-transparent">Digital Excellence</span>
                        </h1>

                        {/* Subheadline */}
                        <p className="text-xl md:text-2xl text-[var(--text-tertiary)] max-w-3xl mx-auto mb-12 animate-slide-up leading-relaxed" style={{ animationDelay: '100ms' }}>
                            We deliver world-class IT consulting, bespoke software engineering,
                            and AI-driven innovations to empower the world&apos;s most ambitious enterprises.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-5 animate-slide-up" style={{ animationDelay: '200ms' }}>
                            <Link
                                href="/contact"
                                className="inline-flex items-center gap-2 px-10 py-4 text-white font-bold bg-gradient-to-r from-amber-500 to-amber-600 rounded-2xl hover:shadow-[0_0_50px_-10px_oklch(75%_0.15_85_/_0.6)] hover:-translate-y-1.5 transition-all duration-300 group"
                            >
                                Get a Consultation
                            ...
                            <Link
                                href="/services"
                                className="inline-flex items-center gap-2 px-10 py-4 font-bold text-[var(--text-primary)] bg-[var(--bg-card)] border-2 border-[var(--border-secondary)] rounded-2xl hover:border-amber-500 hover:text-amber-500 hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300"
                            >
                                Explore Solutions
                            </Link>
                        </div>
                ...
                <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce opacity-50">
                    <div className="w-7 h-12 rounded-full border-2 border-[var(--text-muted)] flex items-start justify-center p-2">
